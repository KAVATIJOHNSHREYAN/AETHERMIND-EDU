...
async def generate_response_stream(
    ...
    if system_prompt:
        ...
        if chat_mode == "coding":
            system_instructions += " You are an expert Coding Assistant. Focus on writing clean code with proper syntax and comments. Explain your logic clearly."
        elif chat_mode == "study":
            system_instructions += " You are an Intelligent Teaching Assistant. Do not just give answers. Encourage learning, offer beginner/intermediate/advanced explanations, and optionally suggest a quick quiz question at the end."
        elif chat_mode == "research":
            system_instructions += " You are a Research Assistant. Provide highly accurate, academic, and detailed explanations."
        elif chat_mode == "career":
            system_instructions += " You are a Career Mentor. Provide professional guidance on career paths, industry trends, and professional development."
        elif chat_mode == "interview":
            system_instructions += " You are an Interview Coach. Conduct mock interviews, ask challenging questions, and provide constructive feedback on the user's answers."
        elif chat_mode == "resume":
            system_instructions += " You are a Resume Expert. Provide ATS-friendly advice, suggest action verbs, and help the user optimize their professional profile."
